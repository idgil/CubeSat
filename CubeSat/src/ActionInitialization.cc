...
//    PrimaryGeneratorGPS* prim = new PrimaryGeneratorAction();
//    SetUserAction(prim);
    ...
    TrackingAction* trackingAction = new TrackingAction(fDetectorConstruction, event);
	SetUserAction(trackingAction);



    SetUserAction(new SteppingAction(runAction, event));
}  
